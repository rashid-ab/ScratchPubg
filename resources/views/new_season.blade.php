                        ...
                        <form role="form" method="post"
                            ...
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        name="season_name" placeholder="Title" required >
                                    </div>
                                     <div class="form-group">
                                        <label>Maker Name</label>
                                        <input type="text" class="form-control"
                                        name="maker_name" placeholder="Maker Name" required >
                                    </div>
                                     <div class="form-group">
                                        <label>Maker Email</label>
                                        <input type="email" class="form-control"
                                        name="maker_email" placeholder="Maker Email" required >
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        name="trailer_link" placeholder="Trailor Link" required >
                                    </div>
                                <div class="form-group">
