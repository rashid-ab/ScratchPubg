            ...
            <div class="col-sm-4" >
                <section class="panel" style="width:674px;margin-left: -77px;">
                    ...
                    <div class="panel-body">
                        <!--         <form role="form"> -->
                        <form role="form"  action="{{ url('update_category') }}" method="post"
                            ...
                            <input type="hidden" name="id" value="{{ $category->id }}">
                                   ...
                                   <div class="form-group">
                                        ...
                                        name="category_name" placeholder="Name" value="{{ $category->category_name }}" required >
                                    </div>
                                
                                    <div class="form-group">
                                        <label>Description</label>
                                        <textarea type="text" class="form-control"
                                        name="description" placeholder="Description" value="" rows="3" style="height:150px;" required >
